...
--\copy dec_2024_ridership FROM '/path/to/mta_ridership_dec2024.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
...
FROM '/path/to/mta_ridership_dec2024.csv'
